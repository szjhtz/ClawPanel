...
[![Pro](https://img.shields.io/badge/Pro-5.2.8-violet?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
[![Lite](https://img.shields.io/badge/Lite-0.1.4-2563eb?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
...
> [!NOTE]
> **最新 Pro / Lite 更新** — `ClawPanel Pro v5.2.8` 补强 macOS OpenClaw 探测、受管工作区兼容与 MiniMax 默认配置；`ClawPanel Lite v0.1.4` 改为整包更新，并支持在安装/更新时选择 GitHub 或加速服务器线路。详见 [changelogs/v5.2.8.md](changelogs/v5.2.8.md) 和 [changelogs/lite-v0.1.4.md](changelogs/lite-v0.1.4.md)
