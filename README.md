...
> [!NOTE]
> **v5.2.4 更新** — Windows / macOS 安装 OpenClaw 改为先检查 Node.js 与 Git 前置依赖，缺失时直接提示用户前往官网手动安装，避免一键安装半途报错。详见 [changelogs/v5.2.4.md](changelogs/v5.2.4.md)
