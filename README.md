...
[![Lite](https://img.shields.io/badge/Lite-0.1.5-2563eb?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
...
> [!NOTE]
> **最新 Pro / Lite 更新** — `ClawPanel Pro v5.2.8` 补强 macOS OpenClaw 探测、受管工作区兼容与 MiniMax 默认配置；`ClawPanel Lite v0.1.5` Windows / macOS Lite 安装包已正式可用，支持一键安装脚本，详见下方安装说明。详见 [changelogs/v5.2.8.md](changelogs/v5.2.8.md) 和 [changelogs/lite-v0.1.5.md](changelogs/lite-v0.1.5.md)
